...
- **[twzrd-sol/wzrd-velocity](https://github.com/twzrd-sol/wzrd-velocity)** - AI model selection and routing using real-time velocity signals; answers "which model should I use for X?" with adoption momentum from HuggingFace, GitHub, OpenRouter, and ArtificialAnalysis, aggregated via Switchboard oracle on Solana and updated every 5 minutes across 100+ models
